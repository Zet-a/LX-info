...
function changeloghandler(){
    ...
    function setCodeText(parsed) {
        ...
        document.querySelector("#changelog_code").innerText = parsed
        highlightall();
        parsed = document.querySelector("#changelog_code").innerHTML;
        ...
        document.querySelector("#changelog_code").innerHTML = parsed
        let elementsInCode = document.querySelector("#changelog_code").children;
